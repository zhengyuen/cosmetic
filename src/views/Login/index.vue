			...
			<div class="text-center border-solid border-[1px]  w-[350px] h-72 rounded-md mx-auto mb-6">
				<h2 class="mt-5 mb-3 pt-5 font-bold">會員登入</h2>
						<form @submit="submit" class="m-5 p-5 " action="">
							...
							<input v-model.trim="formData.username" placeholder="電子郵件地址"  class="focus:outline-0 mb-3 w-52 border-2 border-solid rounded  py-1 pl-1" id="username"><br>
							<label for="password" class="mr-3">密碼</label>
							<input type="password" v-model.trim="formData.password" placeholder="密碼"  class="focus:outline-0 mb-3 w-52 border-2 border-solid rounded px-2 py-1" id="password"><br>
